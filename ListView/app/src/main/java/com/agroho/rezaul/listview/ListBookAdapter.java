...
public class ListBookAdapter extends BaseAdapter{
    ...
    public long getItemId(int position) {
        return listBooks.get(position).getDrawableID();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            holder.ImageBookLogo = (ImageView)convertView.findViewById(R.id.book_logo);
        ...
        holder.ImageBookLogo.setImageResource(book.getDrawableID());
